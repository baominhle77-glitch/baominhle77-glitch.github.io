...
const sandbox = {
  ...
  caches: {
    open: async () => cache,
    keys: async () => ["hiennhi89-v2", "boitoan-v10", "boitoan-v11", "boitoan-v12", "boitoan-v13", "boitoan-v14", "boitoan-v15"],
...
await activation;
assert.deepEqual(deletedCaches, ["boitoan-v10", "boitoan-v11", "boitoan-v12", "boitoan-v13", "boitoan-v14"], "Bói toán must preserve caches owned by root Service Worker and current v15");
